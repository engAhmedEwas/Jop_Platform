...
class JobVacancyUpdateRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'salary.string'=>'The Owner Salary Must Be A String',
            ...
            'category_id.required'=>'The Owner Category Felid Is Required!',
            'category_id.email'=>'The Owner Category Must Be A Valid Email Address!',
            'category_id.unique'=>'The Owner Category Has Already Been Taken!',
        ];
    }
}
