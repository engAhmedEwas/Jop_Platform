        ...
        <form action=" {{route('companies.update', ['company' => $company->id, 'redirectToList' => request('redirectToList')])}} " method="post">
            ...
            <div class="max-w-2xl p-6 mx-auto bg-white rounded-lg shadow-md">
                ...
                <div class="p-6 mb-4 border border-gray-100 rounded-lg shadow-sm bg-gray-50">
                    ...
                    <span>Edit The Company Details </span>

                    <div class="mt-3 mb-2">
                        <label for="name" class="block text-sm font-medium text-gray-700">Company Name</label>
                        <input type="text" name="name" id="name"
                            class="w-full my-2 border-gray-400 rounded-xl {{ $errors->has('name') ? 'outline-red-500 outline outline-1' : '' }} " value="{{old('industry', $company->name)}}">
                    ...
                    <div class="mt-3 mb-2">
                        ...
                        <input type="text" name="address" id="address"
                            class="w-full my-2 border-gray-400 rounded-xl {{ $errors->has('address') ? 'outline-red-500 outline outline-1' : '' }} " value="{{old('industry', $company->address)}}">
                    ...
                    <div class="mt-3 mb-2">
                        <label for="industry"
                        class="block text-sm font-medium text-gray-700">Company Industry</label>
                        <select name="industry" id="industry" value="{{old('industry', $company->industry)}}"
                        class="w-full my-2 border-gray-400 rounded-xl
                        {{ $errors->has('industry') ? 'outline-red-500 outline outline-1' : '' }}">
                    ...
                    <div class="mt-3 mb-2">
                        ...
                        <input type="text" name="website" id="website"
                            class="w-full my-2 border-gray-400 rounded-xl {{ $errors->has('website') ? 'outline-red-500 outline outline-1' : '' }} " value="{{old('industry', $company->website)}}">
                ...
                <div class="p-6 mb-4 border border-gray-100 rounded-lg shadow-sm bg-gray-50">
                    ...
                    <div class="mt-3 mb-2">
                        ...
                        <input type="text" name="owner_name" id="owner_name"
                            class="w-full my-2 border-gray-400 rounded-xl {{ $errors->has('owner_name') ? 'outline-red-500 outline outline-1' : '' }} " value="{{old('owner_name', $company->owner->name)}}">
                    ...
                    <div class="mt-3 mb-2">
                        ...
                        <input type="email" name="owner_email" id="owner_email" disabled
                            class="w-full my-2 border-gray-400 rounded-xl {{ $errors->has('owner_email') ? 'outline-red-500 outline outline-1' : '' }} bg-gray-100" value="{{old('owner_name', $company->owner->email)}}">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="relative" x-data="{ showPassword: false }">
                            ...
                            <x-text-input id="owner_password" class="block w-full mt-1" x-bind:type="showPassword ? 'text' : 'password'" name="owner_password"
                ...
                <div class="flex justify-end space-x-2">
                    <button type="submit" class="px-2 py-4 text-white bg-blue-500 border border-blue-500 hover:bg-blue-700 rounded-xl">Update Company</button>
