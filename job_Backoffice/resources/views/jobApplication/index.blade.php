            ...
            <tbody>
                @forelse($jobApplications as $application)
                    <tr class="border-b">
                        ...
                        <td class="px-6 py-4 @if($application->status == 'accepted') text-green-500 @elseif($application->status == 'rejected') text-red-500 @else ($application->status == 'pending') text-purple-500 @endif"> {{ $application?->status ?? "N/A" }}</td>
                        <td>
